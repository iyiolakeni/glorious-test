 ...
 * @buffer_size: Buffer array to handle print
 ...
 * Return: Number of chars printed
 */
int _string(va_list arg, char buffer[],
 ...
 * Return: Number of chars printed
 */
int _percent(va_list arg, char buffer[],
	int flags, int width, int precision, int size)
{
	UNUSED(arg);
	UNUSED(buffer);
	...
	int flags, int width, int precision, int size)
{
	...
	return (_number_printer(is_negative, i, buffer, flags, width, precision, size));
}
